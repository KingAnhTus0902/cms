            ...
            <div class="modal-body">
                <form id="add-cadres-form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control form-control-sm input-form initialism string-validate"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                >
                                <p id="medical_insurance_symbol_code-add-error" class="error validate-error"></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="medical_insurance_live_code"
                                    class="form-control form-control-sm input-form"
                                    id="medical_insurance_live_code-add">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="checkbox"
                                    ...
                                    disabled
                                >
                                <p id="is_long_date-add-error" class="error validate-error"></p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="insurance_five_consecutive_years-add">
                                {{ __('label.cadres.field.insurance_five_consecutive_years') }}
                                <span class="text-red">(*)</span>
                            </label>
                            <div class="input-group input-group-sm">
                                <div class="input-group date" id="cad-insurance_five_consecutive_years-add"
                                     data-target-input="nearest">
                                    <input type="text" class="datetimepicker-input form-control form-control-sm"
                                           id="insurance_five_consecutive_years-add" disabled
                                           name="insurance_five_consecutive_years" placeholder="Ngày/tháng/năm" data-target="#cad-insurance_five_consecutive_years-add">
                                    <div class="input-group-append"
                                         data-target="#cad-insurance_five_consecutive_years-add" data-toggle="datetimepicker">
                                        <div class="input-group-text form-control-sm"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                            </div>
