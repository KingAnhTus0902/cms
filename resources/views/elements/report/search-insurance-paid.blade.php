...
<div class="card-header">
    <div class="row">
        <div class="col-sm-6">
            <h3 class="card-title">{{ __('title.report.insurance_paid') }}</h3>
    ...
    <div class="row mt-3">
        ...
        <div class="btn-group pull-left">
            ...
            <div class="btn-group pull-left" style="margin-left:10px">
                <a class="btn btn-info submit btn-sm btn-edit-size" onclick="exportInsurancePaid()">
...
<script>
    function exportInsurancePaid(){
        var startDate = $('#startDateSearch').val();
        var endDate = $('#endDateSearch').val();
        var url = "/admin/bao-cao-benh-nhan-bao-hiem-da-thanh-toan/xuat-file-bao-cao-benh-nhan-bao-hiem-da-thanh-toan?start=" + startDate+ "&end="+ endDate;
