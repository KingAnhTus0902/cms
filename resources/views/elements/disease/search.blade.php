<div class="card-header">
    <div class="row">
        <div class="col-sm-6">
            <h3 class="card-title">{{ __('title.disease_page') }}</h3>
        ...
        <div class="col-sm-6 block-button-add">
            @if(auth()->user()->can('Create-disease'))
                <button type="button" class="btn btn-success open-add-modal"
                        data-toggle="modal" data-target="#add-disease">
        ...
        <div class="col-md-12">
            <div class="row justify-content-center">
                <div class="col-md-6 row justify-content-center">
                    <label class="col-md-4 col-lg-4 col-xl-3 col-xxl-2 control-label">{{ __('label.disease.name') }}</label>
                    <div class="col-md-7">
                        <div class="input-group input-group-sm">
                            <input type="text"
                                ...
                                placeholder="{{ __('placeholder.disease.name') }}"
                            >
                ...
                <div class="col-md-6 row justify-content-center">
                    <label class="col-md-4 col-lg-4 col-xl-3 col-xxl-2 control-label">{{ __('label.disease.code') }}</label>
                    <div class="col-md-7">
                        <div class="input-group input-group-sm">
                            <input type="text"
                                    name="code"
                                    id="code-search"
                                    class="form-control form-control-sm"
                                    placeholder="{{ __('placeholder.disease.code') }}"
                            >
