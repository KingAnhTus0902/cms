            ...
            <div class="modal-body">
                <form id="edit-material-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ingredients-edit"
                                    class="col-form-label col-form-label-sm">
                                    {{ __('label.material.field.ingredients') }}
                                </label>
                                <input type="text" class="form-control form-control-sm" id="ingredients-edit"
                                    name="ingredients">
                                <span id="ingredients-edit-error" class="error validate-error"></span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group clearfix">
                                <div class="icheck-primary d-inline">
                                    <input type="checkbox" id="use_insurance-edit" name="use_insurance" value="1"
                                        class="use_insurance_checkbox">
                                    <label for="use_insurance-edit" style="font-size: .875rem;">
                                        {{ __('label.material.field.use_insurance') }}
                                    </label>
                                </div>
                                <span id="use_insurance-edit-error" class="error validate-error"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 insurance_code_input">
                            <div class="form-group">
                                <label for="insurance_code-edit" class="col-form-label col-form-label-sm">
                                    {{ __('label.material.field.insurance_code') }}
                                </label>
                                <input type="text" class="form-control form-control-sm"
                                    id="insurance_code-edit" name="insurance_code">
                                <span id="insurance_code-edit-error" class="error validate-error"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 insurance_unit_price_input">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm price-validate"
                                    id="insurance_unit_price-edit" name="insurance_unit_price">
                                <span id="insurance_unit_price-edit-error" class="error validate-error"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm price-validate"
                                    id="service_unit_price-edit" name="service_unit_price">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="disease_type-edit" class="col-form-label col-form-label-sm">
                                    {{ __('label.material.field.disease_type') }}
                                </label>
                                <input type="text" class="form-control form-control-sm" id="disease_type-edit"
                                    name="disease_type">
                                <span id="disease_type-edit-error" class="error validate-error"></span>
                            </div>
                        </div>
                        <div class="col-md-12">
