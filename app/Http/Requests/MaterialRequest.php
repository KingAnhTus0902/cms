...
class MaterialRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'insurance_code' => 'nullable|string|max:25',
    ...
    public function attributes()
    {
        return [
            ...
            'ingredients' => __('label.material.field.ingredients'),
            'unit_id' => __('label.material.field.unit_id'),
            'service_unit_price' => __('label.material.field.service_unit_price'),
            'use_insurance' => __('label.material.field.use_insurance'),
            'insurance_code' => __('label.material.field.insurance_code'),
            'insurance_unit_price' => __('label.material.field.insurance_unit_price'),
